...
export default function Model2() {
    ...
    const baseUrl = 'https://api.findacarfor.me/specs?page=';
    ...
    const [complaintsFilter, setComplaintsFilter] = useState('Complaints');
    const [recallsFilter, setRecallsFilter] = useState('Recalls');
    ...
    // from https://www.freecodecamp.org/news/axios-react-how-to-make-get-post-and-delete-api-requests/
    // useEffect(() => {
    ...
    // from https://www.freecodecamp.org/news/how-to-consume-rest-apis-in-react/
    useEffect(() => {
        fetch(baseUrl + pageNumber + '&count=10&sort=' + sortName+ (makeFilter != 'Make'?'&make='+makeFilter: '') 
                + (modelFilter != 'Model'?'&model='+modelFilter: '')
                + (yearFilter != 'Year'?'&year='+yearFilter: '')
                + (complaintsFilter != 'Complaints'?'&no_complaints='+complaintsFilter: '')
                + (recallsFilter != 'Recalls'?'&no_recalls='+recallsFilter: '')
        ...
        }, [sortName, modelFilter, makeFilter, yearFilter, complaintsFilter, recallsFilter, pageNumber, searchInputString]);
            ...
            <div>
                ...
                <Row>
                    ...
                    <Col>
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item onClick={()=>setComplaintsFilter('Complaints')}>None</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setComplaintsFilter('True')}>No Complaints</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setComplaintsFilter('False')}>Complaints</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </Col>
                    <Col>
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item onClick={()=>setRecallsFilter('Recalls')}>None</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setRecallsFilter('True')}>No Recalls</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setRecallsFilter('False')}>Recalls</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </Col>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item href="#"onClick={() => onChangeClick('OverallRating')}>Overall Rating</Dropdown.Item>
                        <Dropdown.Item href="#/action-3" onClick={() => onChangeClick('OverallSideCrashRating')}>Overall Side Crash Rating</Dropdown.Item>
                        <Dropdown.Item href="#/action-3" onClick={() => onChangeClick('sideBarrierRatingOverall')}>Overall Side Barrier Rating</Dropdown.Item>
                        <Dropdown.Item href="#/action-2" onClick={() => onChangeClick('ComplaintsCount')}>Number of Complaints</Dropdown.Item>
                        <Dropdown.Item href="#/action-3" onClick={() => onChangeClick('InvestigationCount')}>Number of Investigations</Dropdown.Item>
                        <Dropdown.Item href="#/action-3" onClick={() => onChangeClick('RecallsCount')}>Number of Recalls</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            </div>
